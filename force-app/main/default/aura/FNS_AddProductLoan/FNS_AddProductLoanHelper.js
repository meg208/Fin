({
	doInit:function(component,event,helper){
		...
		helper.createProductLoanCmp(component,event,helper);
		let currencyCode = component.find('currencyisocode');
        if(currencyCode)  component.find('currencyisocode').set('v.disabled',  true);
    },
    createProductLoanCmp: function(component,event,helper) {
